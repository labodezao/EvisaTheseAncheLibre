...
export const CHORD_TYPES = {
  quinte: { name: 'quinte', degrees: [0, 7] },
  majeur: { name: 'majeur', degrees: [0, 4, 7] },
  mineur: { name: 'mineur', degrees: [0, 3, 7] },
  septieme: { name: 'septième', degrees: [0, 4, 10] },
  diminue: { name: 'diminué', degrees: [0, 3, 9] },
  sept5: { name: 'septième avec quinte', degrees: [0, 4, 7, 10] },
};
